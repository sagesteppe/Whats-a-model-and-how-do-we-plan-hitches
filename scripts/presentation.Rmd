...
::: {style="float: right; width: 60%;"}  
![<font size="4">Across Eastern Nevada</font>](../images/Elko-GBNM.png){height=75%, width=75%}
:::
...
::: {style="float: right; width: 60%;"}
<center>
![<font size="4">Hitch Plan</font>](../images/HitchPlan1.png){width=100%}
</center>
:::
...
![<font size="4">Cymopterus bulbosus</font>](../images/Cymopterus_flowering.png){height=10%}
:::
...
- The Price of a house is predicted by it's size, quality, neighborhood, and other factors  
- We generally want to understand the trend of a response in relation to a predictor  
- Oftentimes easy to collect data about the predictor, which with a model can then be used as a surrogate of the response  
:::
...
- *slope* is a change in values, rise over run. 
...
- *Confidence Interval* the probability that the estimated population parameter will fall between two values  
- *Confidence Levels* a level at which to estimate a confidence interval, e.g. so that the CI captures the true population parameter 95% of the time.  
:::

::: {style="float: right; width: 40%;"}
<center>
```{r out.height = "90%", out.width="95%"}
...
::: {style="float: right; width: 40%;"}
<center>
```{r 3D plot of three main variables, out.height = "70%", out.width="70%"}
...
```{r 3D plot with prediction grid, out.height = "70%", out.width="70%"}
par(bg = 'black', col.axis ="white", col.main = 'white', col.lab = 'white')
...
```
![<font size="4">Ames Housing Prices</font>](../images/ames_space.png){height=90%, width=90%}
</center>
::: 
...
::: {style="float: right; width: 60%;"}
![<font size="4">_Cymopterus bulbosus_ - Montrose Area</font>](../images/raw_sdm_output.png){height=90%, width=90%}
:::
...
<center>
![<font size="4">_Cymopterus bulbosus_ - Montrose Area</font>](../images/Occurrence-occupied-drainages.png){width=50%}
</center>
...
![<font size="4">Montrose Area</font>](../images/Phenology-tracker.png){width=100%}
